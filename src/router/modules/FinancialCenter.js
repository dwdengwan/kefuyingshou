...
export default ([
    {
        ...
        children:[
          ...
          },
          {
            ...
            component: resolve => require(['@/views/FinancialCenter/InternetCharging/UnionPay'], resolve)
          },
          {
            path: 'Recover',
            meta: {
          ...
          },
          {
            ...
            component: resolve => require(['@/views/FinancialCenter/FinancialAdjustment/CancellationMonthlyCharges'], resolve)
          },
          {
            path: 'AccountPeriod',
            meta: {
