<template>
    <div class="water-side">
        ...
        <el-tabs v-model="waterSideTabs" type="card" @tab-click="tabActive" closable @tab-remove="removeTab">
            <el-tab-pane
                ...
                <section v-show="idShow" class="homePage">
                    ...
                    <div class="water-side-center">
                        <ol class="water-side-pie">
                            ...
                            <li class="Notice">
                                <h3>
                                    <div><span>{{NoticeTitle}}</span><i class="el-icon-d-arrow-right"></i></div>
                                    
                                    <div><span>{{AgencyTitle}}</span><i class="el-icon-d-arrow-right" @click="addTab(AgencyTitle)"></i></div>
                                </h3>
                                <section>
                                    <div>
    ...
    mounted(){
        ...
        this.$nextTick(()=>{
             //data 里面定义一个axHeight 用于设置table的高度，增加一个v-if事件用于渲染吗，监听maxHeight 的变化控制v-if的变量
              this.$changeTable(this, '.water-side .water-side-right', ['.water-side .table-top','.water-side .blank'])
        })
