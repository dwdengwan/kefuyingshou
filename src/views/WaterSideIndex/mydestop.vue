<template>
    ...
    <div class="mydestop">
        <el-form :inline="true" size="mini" :model="formInline" class="demo-form-inline">
            ...
            <el-form-item label="选择申请部：">
                <el-select v-model="formInline.application" placeholder="选择申请部">
                    <el-option v-for="(v,i) in formInline.options" :label="v.name" :value="v.value" :key="i"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
        ...
        <div class="myDeskConBtn">
            <el-tabs type="border-card" v-model="processingStatus">
                <el-tab-pane :label="v.label" v-for="(v, i) in tabsTitle" :key="i"  :name="v.name">
                    ...
                    <!-- 表格 v-if="tableShow" :max-height="maxHeight" -->
                    ...
                    >
                        ...
                        <el-table-column min-width="280" label="步骤：上一节点|当前节点">
                            <template slot-scope="scope">
    ...
    mounted(){
        ...
        this.$nextTick(()=>{
             //data 里面定义一个axHeight 用于设置table的高度，增加一个v-if事件用于渲染吗，监听maxHeight 的变化控制v-if的变量
              this.$changeTable(this, '.water-side .mydestop', ['.water-side .demo-form-inline','.water-side .applicationDate','.water-side .applicationDate'])
        })
    },
    methods: {
...
@import "../../assets/styles/scss/base/fn";
    .water-side,.WaterSideIndex2{
        ...
        // .mydestop,.comprehensiveBusiness{
        //     padding:0px 20px;
        // }
