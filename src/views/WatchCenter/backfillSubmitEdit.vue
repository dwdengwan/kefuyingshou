  ...
  <div class="backfillSubmitEdit">
    <div class="submit_edit_left">
      ...
      <div class="submit_edit_left_content">
        <el-form :model="leftData" ref="form" label-width="120px">
          ...
          <div class="my-input">
            <el-form-item label="新表编号：" prop="village">
              <el-input v-model="leftData.b" size="mini" clearable></el-input>
            </el-form-item>
          </div>

          <div class="my-input">
            <el-form-item label="新表起码：" prop="village">
              <el-input v-model="leftData.c" size="mini" clearable></el-input>
            </el-form-item>
          </div>
    ...
    <div class="submit_edit_right">
      <div class="toolbar">
        <el-form :inline="true" class="demo-form-inline" label-width="120px">
          ...
          <el-form-item label="计划完工日期：">
            <el-input v-model="searchCon" size="mini" placeholder="计划完工日期" disabled  class="read-only"></el-input>
          </el-form-item>
          <el-form-item label="换表员：">
            <el-input v-model="searchCon" size="mini" placeholder="换表员" disabled  class="read-only"></el-input>
          </el-form-item>
          <el-form-item label="换表类型：">
            <el-input v-model="searchCon" size="mini" placeholder="换表类型" disabled class="read-only"></el-input>
          </el-form-item>
      ...
      <div class="backfillSubmitForm">
        <div class="kl-table">
          <el-table stripe 
                highlight-current-row border :data="histroyData.list">
            ...
            <el-table-column min-width="100"  prop="isxz" label="上期抄码" show-overflow-tooltip>
            </el-table-column>

            <el-table-column min-width="80" prop="offset" label="旧表底码" show-overflow-tooltip>
            </el-table-column>

            <el-table-column min-width="80" prop="model" label="新表编号" show-overflow-tooltip>
            </el-table-column>

            <el-table-column prop="flux" min-width="80"  label="新表起码">
            </el-table-column>

            <el-table-column prop="modifyBy" min-width="80"  label="余量" show-overflow-tooltip>
            </el-table-column>

            <el-table-column min-width="140" prop="meter"  label="换表日期">
            </el-table-column>

            <el-table-column min-width="120" label="旧表水表编号"  prop="model1"  show-overflow-tooltip>
            </el-table-column>

            <el-table-column min-width="120" label="旧表出厂编号" prop="model2"  show-overflow-tooltip>
            </el-table-column>

            <el-table-column prop="status" min-width="120" label="旧表处理方式" show-overflow-tooltip>
            </el-table-column>
        ...
        <!-- <el-form :inline="true" :rules="rules" :model="backfillSubmitForm" label-width="150px">
                ...
                <el-form-item label="换表员：" prop="Template">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        Template: [
          { required: true, message: '换表员', trigger: 'blur' },
        ],
      },
      histroyData: {},
      tableShow: false,
