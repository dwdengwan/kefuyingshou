            ...
            <div class="toolbar">
                <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
                    ...
                    <el-form-item class="form-right">
                        ...
                        <el-button size="mini" @click="add" type="primary">发送短信</el-button>
                        <el-button size="mini" type="primary">发送微信</el-button>
                    </el-form-item>
                ...
                <el-table    
                    ...
                    <el-table-column label="操作" fixed="right" width="250">
                        <template slot-scope="scope">
                            ...
                            <el-button type="text" @click.native="edit(scope.$index, scope.row)">发送短信</el-button> 
