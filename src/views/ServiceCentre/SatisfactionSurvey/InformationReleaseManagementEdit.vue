    ...
    <div class="InformationReleaseManagementEdit">
        ...
        <el-form class="backfillSubmitForm" size="mini" :inline="true" :model="InfoReleaseManagementEditForm" label-width="150px" ref="ruleForm">
            ...
            <el-form-item label="开始日期：">
                <el-date-picker
                    v-model="InfoReleaseManagementEditForm.startDate"
                    type="date"
                    placeholder="选择日期">
                </el-date-picker>
            </el-form-item>
            <el-form-item label="结束日期：">
                <el-date-picker
                    v-model="InfoReleaseManagementEditForm.endDate"
                    type="date"
                    placeholder="选择日期">
                </el-date-picker>
            </el-form-item>
        ...
        <div class="kl-table">
            ...
            <el-table       
                ...
                <el-table-column label="排序" fixed="right" width="130">
    ...
    data(){
        return{
            InfoReleaseManagementEditForm:{
                ...
                channel:['网上营业厅'],
                state:"",
                shortMsgCon:"为了给您提供更好的服务，希望您能抽出几分钟时间，将您的感受和建议告诉我们，我们非常重视每位用户的宝贵意见，期待您的参与！现在我们就马上开始吧！",
                startDate:"",
                endDate:"",
                wechatCon:"",
            },
