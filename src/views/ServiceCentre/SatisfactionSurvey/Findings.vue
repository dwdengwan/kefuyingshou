...
<template>
    <div class="Findings">
        <!-- 弹出表单增加 -->
    	<el-dialog :title="FindingsName" :close-on-click-modal="false" :visible.sync="FindingsVisible" class="addDialog" @close="closeDialog" >
            <FindingsEdit
                ref="childFindings" 
            ></FindingsEdit>
                ...
                <el-form-item class="form-left">
                    ...
                    <el-form-item label="答卷渠道：">
                        <el-select v-model="formData.waterMeterType" placeholder="请选择">
                            <el-option
                            v-for="item in formData.waterMeterTypeOptions"
                            :key="item.value"
                            :label="item.name"
                            :value="item.value">
                            </el-option>
                    ...
                    <el-form-item label="模糊查询：">
                        <el-input v-model="formData.con" class="searchInput" placeholder="问卷主题/答卷人"></el-input>
                    </el-form-item>
      ...
      return {
        crumbsData :{  //面包屑
            titleList:[
                ...
                {title:'调查结果',method:()=>{window.histroy.back()}},
