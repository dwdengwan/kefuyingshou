...
<!--     
      ...
      <div v-if="EditVisible">
        <holidaySetEdit ref="childWarehousing"></holidaySetEdit>
      </div>
      ...
      <div v-else >
        <div class="toolbar">
            <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
                ...
                <el-form-item class="form-left">
                    ...
                    <el-form-item label="假期说明：" class="">
                        <el-input v-model="formData.con" clearable placeholder="假期说明"></el-input>
                    </el-form-item>
        ...
        <div class="holiday-set-right-content">
          ...
          <div class="kl-table">
            <el-table 
              ...
              <el-table-column prop="areaName" min-width="100" label="假期名称">
              </el-table-column>
              ...
              <el-table-column prop="areaValue" min-width="200" label="假期说明" show-overflow-tooltip>
              </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      tableData:[
        {
          areaName:'国庆',
          time:"2019-10-01~2019-10-07",
          areaState:'启用',
          areaValue:'假期设置已启用客服营收系统',
        },
        {
          areaName:'国庆',
          time:"2019-10-01~2019-10-07",
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '假期设置', method: () => { window.histroy.back() } }
        ],
      },
      rules: {
        Applicant: [
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.$changeTable(this, '.holiday-set .holiday-set-right', ['.holiday-set .table-top'])
    })
  },
  methods: {
    init() {
