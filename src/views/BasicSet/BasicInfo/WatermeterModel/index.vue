<template>
  <div class="water-mater-manfa">
      ...
      <div v-if="EditVisible">
        <WatermeterModelEdit ref="childWarehousing"></WatermeterModelEdit>
      </div>
        ...
        <div class="toolbar">
            <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
                ...
                <el-form-item class="form-left">
                    ...
                    <el-form-item label="水表型号：" class="">
                      <!-- <el-select v-model="formData.con" clearable size="mini">
                        <el-option v-for="item in conType" :key="item.value" :label="item.label" :value="item.value"></el-option>
                      </el-select> -->
                      <el-input v-model="formData.con"
                                placeholder="请输入水表型号">
                      </el-input>
                    </el-form-item>
        ...
        <div class="water-mater-manfa-right-content">
          <div class="kl-table">
            <el-table 
              ...
              <el-table-column prop="rrr" min-width="100" label="水表型号" show-overflow-tooltip>
              </el-table-column>
              <el-table-column prop="meter" min-width="100" label="水表型式" show-overflow-tooltip>
              </el-table-column>
              <el-table-column prop="meter" min-width="100" label="传输方式" show-overflow-tooltip>
              </el-table-column>
              <el-table-column prop="meter" min-width="100" label="水表传感器" show-overflow-tooltip>
              </el-table-column>
