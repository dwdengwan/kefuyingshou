<template>
  <div class="cost-project">
      ...
      <div v-if="EditVisible">
        <CostProjectEdit ref="childWarehousing"></CostProjectEdit>
      </div>
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '费用名称', method: () => { window.histroy.back() } }
        ],
      },
      rules: {
        Applicant: [
      ...
      treeDatas: {
        tree: [{ foreignkey: '根目录', id: '222', _child: [{ foreignkey: '水费_ZBSF', id: '222'},{ foreignkey: '污水处理费_WSCL', id: '222'},{ foreignkey: '垃圾处理费_LJCL', id: '222'}] }],
        defaultProps: {
          label: 'foreignkey',
          children: '_child'
        },
