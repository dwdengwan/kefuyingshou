  ...
  <div class="BreakSet">
    ...
    <!-- <div class="bread-contain">
      ...
      <div class="bread-contain-right" v-if="EditVisible">
          ...
          <!-- <el-dialog title="用水价格-增加" :close-on-click-modal="false" :visible.sync="dialogFormVisible" width="60%">
                <BreakSetEdit></BreakSetEdit>
      ...
      <div v-if="EditVisible">
          ...
          <BreakSetEdit ref="childWarehousing"></BreakSetEdit>
      </div>
        ...
        <div class="break-set-right-content">
          <div class="kl-table">
            <el-table 
              ...
              <el-table-column prop="type" min-width="100" label="违约金名称">
              </el-table-column>

              <el-table-column prop="breakLevel" min-width="100" label="计算方式">
              </el-table-column>

              <!-- <el-table-column prop="breakLevel" min-width="180" label="违约一天收款比例">
              </el-table-column> -->

              <!-- <el-table-column prop="startTime" min-width="120" label="开始日期">
              </el-table-column>
              
              <el-table-column prop="endTime" min-width="120" label="结束日期">
              </el-table-column> -->

              <el-table-column prop="minPrice" min-width="120" label="最低计算金额">
              </el-table-column>

              <el-table-column prop="minBreakPrice" min-width="120" label="最低违约金额">
              </el-table-column>

              <el-table-column prop="minBreakPrice" min-width="120" label="最高违约金额">
              </el-table-column>

              <el-table-column prop="minPrice" min-width="120" label="每天收取比例">
              </el-table-column>

              <el-table-column prop="minBreakPrice" min-width="120" label="最高收取比例">
              </el-table-column>

              <el-table-column prop="count" min-width="120" label="保留小数位数">
              </el-table-column>
