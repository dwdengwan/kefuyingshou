<template>
  <div class="business-area">
    ...
    <section class="business-area-right">
      <BusinessArea v-if="$route.path==='/BusinessArea'"></BusinessArea>
      <router-view v-else></router-view>
    </section>
  </div>
</template>
<script>
import BusinessArea from './BasicInfo/BusinessArea/BusinessArea'
export default {
...
.business-area {
  ...
  & > .business-area-right {
    ...
    .el-table {
      .el-table__body .el-input__inner,.el-textarea__inner{
        height: 28px;
        line-height: 28px;
      }
      .el-textarea__inner{
