...
<template>
  ...
  <div class="AccountPeriod">
    <!-- 弹出表单编辑 -->
    <!-- <el-dialog :title="AccountPeriodName" :close-on-click-modal="false" :visible.sync="AccountPeriodVisible" class="addDialog" @close="closeDialog" >
            <AccountPeriodEdit
                ref="childAccountPeriod" 
            ></AccountPeriodEdit>
    ...
    <!-- <div class="bread-contain">
            ...
            <div class="bread-contain-right" v-if="AccountPeriodVisible">
                <el-button size="mini" type="primary">保存</el-button>
                <el-button  icon="el-icon-caret-left" size="mini" @click="closeDialog">返回</el-button>
            </div>
            <div class="bread-contain-right" v-show="AccountPeriodCon">
                <el-button icon="el-icon-plus" size="mini" @click="add" type="primary">添加</el-button>       
                <el-button @click="exportExcel" icon="el-icon-delete" size="mini" type="primary">删除</el-button>
            </div>
        </div> -->
...
export default {
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '账结管理', method: () => { window.histroy.back() } },
  ...
  mounted() {
    ...
    this.$changeTable(this, '.AccountPeriod', ['.AccountPeriod .toolbar', '.AccountPeriod .block', '.AccountPeriod #crumbs'])
  },
  methods: {
    init() {
