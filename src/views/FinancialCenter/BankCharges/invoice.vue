            ...
            <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
                ...
                <el-form-item class="form-left">
                    ...
                    <!-- <el-form-item label="收费项目：">
                        <el-radio v-model="DateChoosevalue" label="1">水费</el-radio>
                        <el-radio v-model="DateChoosevalue" label="2">污水处理费</el-radio>
                        <el-radio v-model="DateChoosevalue" label="3">垃圾处理费</el-radio>
                    </el-form-item> -->
                    <el-form-item label="发票类型：">
                        <el-select v-model="formData.watermeterWarehouse" placeholder="请选择">
                            <el-option
                            v-for="item in formData.watermeterWarehouseOptions"
                            :key="item.value"
                            :label="item.name"
                            :value="item.value">
                            </el-option>
