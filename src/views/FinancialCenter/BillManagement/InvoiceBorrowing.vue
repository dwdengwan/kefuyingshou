...
<template>
    ...
    <div class="InvoiceBorrowing">
        <!-- 弹出表单编辑 -->
    	<!-- <el-dialog :title="InvoiceBorrowingName" :close-on-click-modal="false" :visible.sync="InvoiceBorrowingVisible" class="addDialog" @close="closeDialog" >
            <InvoiceBorrowingEdit
                ref="childInvoiceBorrowing" 
                :type="true"
            ></InvoiceBorrowingEdit>
                ...
                <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
                    ...
                    <el-form-item class="form-left">
                        ...
                        <el-form-item label="营业网点：">
                            ...
                            <!-- <el-input v-model="formData.con" placeholder="请输入营业网点"></el-input> -->
                        </el-form-item>
                        <el-form-item label="领用人：">
                            <el-input v-model="formData.con1" placeholder="请输入领用人"></el-input>
                        </el-form-item>
                        <!-- <el-form-item label="模糊查询：" class="searchInput">
                            <el-input v-model="formData.con" placeholder="票据类型/发票代码/开始号码"></el-input>
                        </el-form-item> -->
                    ...
                    <!-- <el-form-item class="form-right">
                        <el-button size="mini" @click="add" type="primary">借用</el-button>
            ...
            <div class="kl-table">
                <el-table
                    ...
                    <el-table-column label="操作" fixed="right" width="120">
                        ...
                        <el-button type="text"  @click="add">借用</el-button>
                        <el-button type="text" @click.native="edit(scope.$index, scope.row)">归还</el-button>
                        </template>
                    </el-table-column>
...
export default {
    ...
    components:{
     ...
     data(){
        return{
            crumbsData :{  //面包屑
                titleList:[
                    {title:'财务中心',path:'/InvoiceBorrowing'},
                    {title:'票据管理',method:()=>{window.histroy.back()}},
                    {title:'发票借用',method:()=>{window.histroy.back()}},
    ...
    mounted(){
      ...
      this.$changeTable(this,'.InvoiceBorrowing',['.InvoiceBorrowing .toolbar','.InvoiceBorrowing .block','.InvoiceBorrowing #crumbs'])
    },
    methods:{
        init(){
    ...
    //     })
      ...
      indexMethod(index) {//获取表格序号
        ...
        add(){
            ...
            this.$set(this.crumbsData.titleList,"3",{title:'借用',method:()=>{window.histroy.back()}})
