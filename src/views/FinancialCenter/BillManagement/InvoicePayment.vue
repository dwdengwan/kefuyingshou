    ...
    <div class="InvoicePayment">
        ...
        <div class="toolbar">
            <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
                ...
                <!-- <el-form-item class="form-right">
                    <el-button size="mini" @click="add" type="primary">交票</el-button>
        ...
        <el-table
            ...
            <el-table-column label="操作" fixed="right" width="80">
                ...
                <!-- <el-button type="text" @click.native="edit(scope.$index, scope.row)">取消</el-button> -->
                </template>
            </el-table-column>
...
export default {
    name:"InvoicePayment",
     data(){
        return{
            crumbsData :{  //面包屑
                titleList:[
                    {title:'财务中心',path:'/InvoicePayment'},
                    {title:'票据管理',method:()=>{window.histroy.back()}},
                    {title:'发票交票',method:()=>{window.histroy.back()}},
    ...
    mounted(){
      ...
      this.$changeTable(this,'.InvoicePayment',['.InvoicePayment .toolbar','.InvoicePayment .block','.InvoicePayment #crumbs'])
    },
    methods:{
        init(){
