...
export default {
    name:"InvoiceInvalidated",
     data(){
        return{
            crumbsData :{  //面包屑
                titleList:[
                    {title:'财务中心',path:'/InvoiceInvalidated'},
    ...
    mounted(){
      ...
      this.$changeTable(this,'.InvoiceInvalidated',['.InvoiceInvalidated .toolbar','.InvoiceInvalidated .block','.InvoiceInvalidated #crumbs'])
    },
    methods:{
        init(){
