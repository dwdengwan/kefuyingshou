...
<template>
    ...
    <div class="CancellationMonthlyCharges">
        ...
        <div class="toolbar">
            <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
                ...
                <el-form-item class="form-right">
                    <el-button size="mini" @click="add" type="primary">取消收款（发票作废）</el-button>
                    <el-button size="mini" type="primary">修改缴费类型</el-button>
                </el-form-item>
            </el-form>
        </div>
        <div class="kl-table">
...
<script>
export default {
    name:"CancellationMonthlyCharges",
     data(){
        return{
            crumbsData :{  //面包屑
                titleList:[
                    {title:'财务中心',path:'/CancellationMonthlyCharges'},
            ...
            CancellationMonthlyChargesVisible:false,  //综合查询的显示和隐藏
            CancellationMonthlyChargesName:'坏账处理-增加',
            ruleFormData:{},
    ...
    //     })
      ...
      indexMethod(index) {//获取表格序号
        ...
        closeDialog(){ //关闭会话
            this.CancellationMonthlyChargesVisible = false;
            this.backfillVisible = false;
            this.init()
        },
        //弹出框
        submit(formName){	//提交
            this.$refs.childCancellationMonthlyCharges.submit()
            // this.CancellationMonthlyChargesVisible = false;
        },
        add(){
            this.CancellationMonthlyChargesVisible = true;
        },
        edit(){
