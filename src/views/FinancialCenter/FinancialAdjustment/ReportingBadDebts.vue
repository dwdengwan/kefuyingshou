...
<template>
    ...
    <div class="ReportingBadDebts">
        <!-- 弹出表单编辑 -->
    	<!-- <el-dialog :title="ReportingBadDebtsName" :close-on-click-modal="false" :visible.sync="ReportingBadDebtsVisible" class="addDialog" @close="closeDialog" >
            <ReportingBadDebtsEdit
                ref="childReportingBadDebts" 
        ...
        <div v-if="ReportingBadDebtsVisible" >
            <ReportingBadDebtsEdit
                ref="childReportingBadDebts" 
                :tableData="histroyData"
            ></ReportingBadDebtsEdit>
...
export default {
    ...
    components:{
     ...
     data(){
        return{
            crumbsData :{  //面包屑
                titleList:[
                    {title:'账务中心',path:'/ReportingBadDebts'},
                    {title:'账务调整',method:()=>{window.histroy.back()}},
                    {title:'坏账报损',method:()=>{window.histroy.back()}},
    ...
    mounted(){
      ...
      this.$changeTable(this,'.ReportingBadDebts',['.ReportingBadDebts .toolbar','.ReportingBadDebts .block','.ReportingBadDebts #crumbs'])
    },
    methods:{
        init(){
