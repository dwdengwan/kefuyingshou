            ...
            <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
                ...
                <el-form-item class="form-left">
                    ...
                    <el-form-item label="模糊查询：">
                        <el-input v-model="formData.waterMeterStatus" class="searchInput" placeholder="用户编号/流水号"></el-input>
                    </el-form-item>
                ...
                <el-form-item class="form-right">
                    ...
                    <!-- <el-button size="mini" type="primary">修改缴费方式</el-button> -->
                </el-form-item>
            </el-form>
        </div>
            ...
            <div class="left-table" v-show="leftTableShow">
                <el-table
                    ...
                    <el-table-column label="操作" fixed="right" width="100">
                        ...
                        <span style='color:#f0f0f0;' v-show="scope.row.modifyBy==='2'">|</span>
                ...
                <el-table
                    ...
                    <el-table-column label="操作" fixed="right" width="180">
                        <template slot-scope="scope">
                            ...
                            <span style='color:#f0f0f0;' v-show="scope.row.status==='1'">|</span>
...
export default {
    ...
    mounted(){
      ...
      this.$changeTable(this,'.UnionPay',['.UnionPay .toolbar','.UnionPay .block','.UnionPay #crumbs'])
    },
    methods:{
        init(){
