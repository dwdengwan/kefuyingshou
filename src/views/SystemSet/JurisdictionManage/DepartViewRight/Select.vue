<template>
  <div class="depart-view-right">
      ...
      <div class="depart-view-right-right-content">
        <div class="kl-table">
          <el-table 
                    v-if="tableShow" 
...
export default {
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '部门查看权', method: () => { window.histroy.back() } }
        ],
      },
      rules: {
        Applicant: [
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.$changeTable(this, '.depart-view-right .depart-view-right-right', ['.depart-view-right .table-top'])
    })
  },
  methods: {
    init() {
...
$theme-color: #297acc;
.depart-view-right {
  .depart-view-right-right-content {
    height: 87%;
    overflow-y: auto;
  }
  .kl-table {
