<template>
  <div class="add-set-del">
      ...
      <div class="add-set-del-right-content">
        <div class="kl-table">
          <el-table 
                    v-if="tableShow" 
...
export default {
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '增删改权', method: () => { window.histroy.back() } }
        ],
      },
      rules: {
        Applicant: [
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.$changeTable(this, '.add-set-del .add-set-del-right', ['.add-set-del .table-top'])
    })
  },
  methods: {
    init() {
