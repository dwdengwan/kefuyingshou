<template>
  <div class="area-view-right">
      ...
      <div class="area-view-right-right-content">
        <div class="kl-table">
          <el-table 
                    v-if="tableShow" 
...
export default {
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '区域查看权', method: () => { window.histroy.back() } }
        ],
      },
      rules: {
        Applicant: [
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.$changeTable(this, '.area-view-right .area-view-right-right', ['.area-view-right .table-top'])
    })
  },
  methods: {
    init() {
