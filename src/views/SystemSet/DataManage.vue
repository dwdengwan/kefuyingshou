<template>
  <div class="data-manage">
      ...
      <div class="data-manage-right-content">
        <div class="kl-table">
          <el-table 
                    v-if="tableShow" 
            ...
            <el-table-column prop="dbName" min-width="80" label="数据库名称">
            </el-table-column>
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.$changeTable(this, '.data-manage .data-manage-right', ['.data-manage .table-top'])
    })
  },
  methods: {
    init() {
