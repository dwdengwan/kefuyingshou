<template>
  <div class="water-manage">
      ...
      <div class="water-manage-right-content">
        <div class="kl-table">
          <el-table 
                    v-if="tableShow" 
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.$changeTable(this, '.water-manage .water-manage-right', ['.water-manage .table-top'])
    })
  },
  methods: {
    init() {
