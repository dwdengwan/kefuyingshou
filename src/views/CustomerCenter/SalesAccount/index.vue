...
<template>
  <div class="SalesAccount">
    ...
    <div  v-if="SalesAccountVisible">
      ...
      <SalesAccountEdit ref="childSalesAccount"></SalesAccountEdit>
      <span class="qianfei" v-if="TransferDetailsGH">
          <el-dialog class="qianfei"  title="欠费明细" :close-on-click-modal="false" :visible.sync="TransferDetailsGH">
            <el-table stripe border center :data="historyData.list" class="change-tables-table">

              <el-table-column type="index" label="NO." width="50" fixed="left">
              </el-table-column>

              <el-table-column prop="month" min-width="150" label="账期">
              </el-table-column>

              <el-table-column prop="fname" min-width="100" label="费用名称">
              </el-table-column>

              <el-table-column prop="value" min-width="180" label="计量水量">

              </el-table-column>

              <el-table-column prop="money" min-width="180" label="欠费金额">
              </el-table-column>

              <el-table-column prop="fare" min-width="180" label="费用状态">
              </el-table-column>
  ...
  <div  v-if="SalesAccountAddVisible">
    <div class="bread-contain">
      <publicCrumbs :crumbsData="crumbsData"></publicCrumbs>
      <div class="bread-contain-right">
        <el-button type="primary" size="mini" @click="TransferDetailsGH = true">欠费明细</el-button>
  ...
  <div  v-if="!SalesAccountVisible && !SalesAccountAddVisible">
    <div class="bread-contain">
      <publicCrumbs :crumbsData="crumbsData"></publicCrumbs>
      <!-- <h2 class="tab-title">
            <i></i>
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" class="change-tables-table">
        ...
        <el-table-column prop="code" min-width="80" label="审批状态">
        </el-table-column>

        <el-table-column prop="fixValue" min-width="80" label="受理日期">
        </el-table-column>

        <el-table-column prop="connect" min-width="80" label="受理单号">
        </el-table-column>
        ...
        <el-table-column prop="flux" min-width="80" label="拆表抄码">
        </el-table-column>
...
import SalesAccountAdd from './SalesAccountAdd'
...
export default {
  ...
  data() {
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          { title: '客户中心', path: '/SalesAccount' },
          { title: '销户', method: () => { window.histroy.back() } }
        ],
      ...
      SalesAccountVisible: false,  //综合查询的显示和隐藏
  ...
  methods: {
    ...
    closeDialog() { //关闭会话
      ...
      this.SalesAccountAddVisible = false;
      this.init()
    },
    closeChooseuser(){
    ...
    //弹出框
    submit(formName) {	//提交
      this.$refs.childSalesAccount.submit()
      // this.SalesAccountVisible = false;
    },
    edit() {
      this.SalesAccountVisible = true;
      this.crumbsData.titleList.push({ title: '编辑', method: () => { window.histroy.back() } })
    },
    salesAdd(){
      this.SalesAccountAddVisible = true;
