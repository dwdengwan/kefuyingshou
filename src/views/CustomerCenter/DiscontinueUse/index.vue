<template>
  ...
  <div class="DiscontinueUse">
    ...
    <div v-if='!waterAddVisible && !waterAddVisibleAdd'>
      <div class="bread-contain">
        ...
        <div class='bread-contain-right'>
          <el-button icon="el-icon-plus" @click="tingyongAdd" size="mini" type="primary">添加</el-button>
          <!-- <el-button @click="exportExcel" icon="el-icon-upload2" size="mini" type="primary" style="margin-right:1.5%;">导出</el-button> -->
        </div>
      </div>
      <div class="toolbar">
        <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
          ...
          <el-form-item class="form-left">
            ...
            <el-form-item label="审批状态：">
              <el-select clearable v-model="formData.waterMeterManufacturer" placeholder="未审批">
      ...
      <div class="kl-table">
        <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" class="change-tables-table">
          ...
          <el-table-column prop="connect" min-width="80" label="受理日期">
          </el-table-column>
          ...
          <el-table-column prop="connect" min-width="200" label="用户名称">
          </el-table-column>

          <el-table-column prop="connect" min-width="80" label="是否拆表">
          </el-table-column>

          <el-table-column prop="connect" min-width="80" label="上期抄码">
          </el-table-column>

          <el-table-column prop="connect" min-width="80" label="拆表拆码">
          </el-table-column>

          <el-table-column prop="connect" min-width="80" label="备注">
          </el-table-column>

          <el-table-column prop="connect" min-width="80" label="受理人">
          </el-table-column>

          <el-table-column prop="connect" min-width="80" label="审核日期">
          </el-table-column>

          <el-table-column prop="connect" min-width="80" label="审核人">
          </el-table-column>
          ...
          <el-table-column label="操作" fixed="right" width="150">
            <template slot-scope="scope">
              ...
              <el-button type="text" class="noclick">审核</el-button>
              <span style='color:#f0f0f0;'>|</span>
    ...
    <div v-if="waterAddVisible" class='waterAddVisible'>
      <div class="bread-contain waterAddVisible-top">
        <publicCrumbs :crumbsData="crumbsData"></publicCrumbs>
        <div class='bread-contain-right'>
      ...
      <DisuseProcedure ref="childWaterEditor" class="waterAddVisible-buttom"></DisuseProcedure>
      <span class="qianfei" v-if="TransferDetailsGH">
        <el-dialog class="qianfei" title="欠费明细" :close-on-click-modal="false" :visible.sync="TransferDetailsGH" append-to-body>
          <el-table stripe border :data="historyData.list" class="change-tables-table">

            <el-table-column type="index" label="NO." width="50" fixed="left">
            </el-table-column>

            <el-table-column prop="code" min-width="150" label="账期">
            </el-table-column>

            <el-table-column prop="areaName" min-width="100" label="费用名称">
            </el-table-column>

            <el-table-column prop="daytime" min-width="180" label="计量水量">

            </el-table-column>

            <el-table-column prop="daytime" min-width="180" label="欠费金额">
    ...
    <div v-if="waterAddVisibleAdd" class='waterAddVisible'>
      <div class="bread-contain waterAddVisible-top">
        <publicCrumbs :crumbsData="crumbsData"></publicCrumbs>
        <div class='bread-contain-right'>
          <el-button type="primary" size="mini" @click="TransferDetailsGH = true">欠费明细</el-button>
      ...
      <DisuseProcedureAdd ref="childWaterEditor" class="waterAddVisible-buttom"></DisuseProcedureAdd>
      <span class="qianfei" v-if="TransferDetailsGH">
        <el-dialog class="qianfei" title="欠费明细" :close-on-click-modal="false" :visible.sync="TransferDetailsGH" append-to-body>
          <el-table stripe border :data="historyData.list" class="change-tables-table">
...
<script>
import DisuseProcedure from './DisuseProcedure'
import DisuseProcedureAdd from './DisuseProcedureAdd'
...
export default {
  ...
  data() {
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          { title: '客户中心', path: '/DiscontinueUse' },
          { title: '停用', method: () => { window.histroy.back() } }
        ],
