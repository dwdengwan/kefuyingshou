...
<template>
  ...
  <div v-else-if="customerManagementVisible == '2'">
    <div class="bread-contain">
      <publicCrumbs :crumbsData="crumbsData"></publicCrumbs>
      <div class="bread-contain-right">
        <el-button size="mini" icon="el-icon-s-check" type="primary">确定并户</el-button>
      ...
      <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
        ...
        <el-form-item class="form-left">
          ...
          <el-form-item label="模糊查询：" class="searchInput">
            <el-tooltip class="item" effect="dark" content="用户编号、账户编号、客户编号、客户名称、客户地址、联系人、联系电话" placement="top">
    ...
    return {
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '客户管理', method: () => { window.histroy.back() } }
        ],
