...
<template>
  <div class="customerManagementEdit">
    ...
    <el-form class="backfillSubmitForm" :inline="true" :model="customerManagementEditForm" label-width="160px" ref="ruleForm" :rules="rules">
      <legend>客户信息</legend>
    ...
    <el-dialog title="查看流水" class="FlowingTabel" :close-on-click-modal="false" :visible.sync="FlowingTableVisible" @close="FlowingTableVisible = false">
        ...
        <PredepositDdetailsInfo></PredepositDdetailsInfo>
    </el-dialog>
