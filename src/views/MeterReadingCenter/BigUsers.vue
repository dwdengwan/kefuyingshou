  ...
  <div class="BigUsers">
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" @cell-click="cellClick" class="wuserInfo-table">
        ...
        <el-table-column prop="code" min-width="180" label="册本号">
        </el-table-column>
        ...
        <el-table-column prop="concentrator" min-width="120" label="本期抄码">
        </el-table-column>
        ...
        <el-table-column prop="concentrator" min-width="120" label="环比率">
        </el-table-column>

        <el-table-column prop="status" min-width="150" label="去年同期水量">
        </el-table-column>

        <el-table-column prop="concentrator" min-width="120" label="同比率">
        </el-table-column>
...
export default {
  ...
  mounted() {
    ...
    this.$changeTable(this, '.BigUsers .kl-table', ['.BigUsers .toolbar', '.BigUsers .block', '.BigUsers bread-contain'])
  },
  methods: {
    init() {
