  ...
  <div class="MeterReadingEquipment">
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" @cell-click="cellClick" class="wuserInfo-table">
        ...
        <el-table-column prop="lvalue" min-width="80" label="联系电话">
        </el-table-column>
...
export default {
  ...
  mounted() {
    ...
    this.$changeTable(this, '.MeterReadingEquipment .kl-table', ['.MeterReadingEquipment .toolbar', '.MeterReadingEquipment .block', '.MeterReadingEquipment bread-contain'])
  },
  methods: {
    init() {
