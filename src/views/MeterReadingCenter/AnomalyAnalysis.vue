  ...
  <div class="AnomalyAnalysis">
    <div class="bread-contain">
      ...
      <div class="bread-contain-right">
        <!-- <el-button size="mini" type="primary">下发核查</el-button> -->
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" @cell-click="cellClick" class="wuserInfo-table">
        ...
        <el-table-column prop="meterAddress" min-width="120" label="是否下发核查"></el-table-column> -->
...
export default {
    ...
    return {
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '水量异常', method: () => { window.histroy.back() } }
        ],
  ...
  mounted() {
    ...
    this.$changeTable(this, '.AnomalyAnalysis .kl-table', ['.AnomalyAnalysis .toolbar', '.AnomalyAnalysis .block', '.AnomalyAnalysis bread-contain'])
  },
  methods: {
    init() {
