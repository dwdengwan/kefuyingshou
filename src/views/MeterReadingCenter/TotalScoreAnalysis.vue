<template>
  <div class="MeterRelationship">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <!-- <el-tab-pane label="子母表分析" name="second">
        <div class="toolbar">
          <el-form :inline="true" size="mini" :model="formData1" class="demo-form-inline">
            <span class="meter-type">子母表</span>

            <el-form-item label="账期：" style="margin-left: 5%;">
              <el-date-picker v-model="formData1.beginYearM" size="mini" type="month" unlink-panels format="yyyyMM" value-format="yyyyMM" placeholder="选择月" style="width:100%;">
              </el-date-picker>
            </el-form-item>

            <el-form-item label="营业区域：">
              <el-select v-model="formData1.department" size="mini">
                <el-option label="全部" value="0"></el-option>
                  <el-option label="城市" value="1"></el-option>
                  <el-option label="农村" value="2"></el-option>
              </el-select>
            ...
            <el-form-item label="模糊查询：" class="longinput">
              <el-input v-model="formData1.searchType" placeholder="册本/总表编号/总表名称/总表地址"></el-input>
            </el-form-item>
        ...
        <div class="kl-table">
          <el-table stripe border :data="histroyData.list" class="change-tables-table">
            ...
            <el-table-column prop="lvalue" min-width="80" label="子表户号">
            </el-table-column>
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '总分分析', path:'/TotalScoreAnalysis' },
