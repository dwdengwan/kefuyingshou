<template>
  <div class="MeterReadingCircuit">
    ...
    <div class="Meter-Reading-Record-right-content">
      <div class="kr-left">
      ...
      <div class="kr-right">
        <div class="toolbar">
          <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
            ...
            <!-- <el-form-item label="模糊查询：" class="longinput">
              <el-tooltip class="item" effect="dark" content="用户编号、册本号" placement="top">
        ...
        <div class="kl-table">
          <el-table 
            ...
            <!-- <el-table-column prop="sortNum" label="排序号" min-width="70">
            </el-table-column> -->
            ...
            <!-- <el-table-column prop="creditRating" label="信用等级" min-width="120">
            </el-table-column> -->
            ...
            <el-table-column label="操作" min-width="120" fixed="right">
              <template slot-scope="scope">
                <!-- disabled='{scope.row.bookNum == "1"' -->
                <el-button type="text" @click.native="edit(scope.$index, scope.row)" style="font-size:12px;">上插入</el-button>
                <span style="color:#e6e6e6;">|</span>
                <el-button type="text" @click.native="edit(scope.$index, scope.row)" style="font-size:12px;">下插入</el-button>
              </template>
            </el-table-column>
          </el-table>
          <!-- 分页 -->
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '抄表',  },
          { title: '抄表路线', method: () => { window.histroy.back() } }
        ],
