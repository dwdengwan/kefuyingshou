  ...
  <div class="AbnormalVerification">
      ...
      <div class="bread-contain">
        ...
        <div class="bread-contain-right" v-else>
            <!-- <el-button size="mini" icon="el-icon-plus" @click="add" type="primary">添加</!-->
        </div>
      </div>
    ...
    <div v-else>
      ...
      <div class="kl-table">
        <el-table stripe border :data="histroyData.list" @cell-click="cellClick" class="wuserInfo-table">
          ...
          <el-table-column prop="meterAddress" min-width="80" label="水表编号"></el-table-column>
          <el-table-column prop="meterAddress" min-width="80" label="水表"></el-table-column>
          ...
          <!-- <el-table-column prop="meterAddress" min-width="120" label="实际用水量"></el-table-column>
          ...
          <!-- <el-table-column prop="meterAddress" min-width="80" label="本期抄码">
            
            <template slot-scope="scope">
              <el-input v-model="scope.row.meterAddress"></el-input>
            </template>
          </el-table-column> -->
...
export default {
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '异常', path: '/AnomalyAnalysis' },
          { title: '水表异常', method: () => { window.histroy.back() } }
        ],
  ...
  mounted() {
    ...
    this.$changeTable(this, '.AbnormalVerification .kl-table', ['.AbnormalVerification .toolbar', '.AbnormalVerification .block', '.AbnormalVerification bread-contain'])
  },
  methods: {
    init() {
