    ...
    <div class="QualityReadingEdit">
        <el-dialog
         ...
         <div class="backfillSubmitForm">
            <!-- <div  class="toolbar">
                    <div class="form-left">
                        <div class="info"><div class="toolbar-line"></div>策略信息</div>
                    </div>
                </div> -->
            <el-form :inline="true" size="mini" :model="form" label-width="80px" style="margin-top:2%;">
                ...
                <!-- <div  class="toolbar">
                    <div class="form-left">
                        <div class="info"><div class="toolbar-line"></div>优惠明细</div>
                    </div>
                    <div class="form-right">
                        <el-button icon="el-icon-plus"  @click="dialogVisible = true" type="primary" size='mini'>添加水表</el-button>
                    </div>
                </div> -->
             ...
             <el-table 
              ...
              <el-table-column prop="stageMoney" min-width="100" label="预估抄码">
                <!-- <template slot-scope="scope">
                  <el-input 
                    v-model="scope.row.stageMoney"
                    placeholder="请输入日均水量">
              ...
              <el-table-column prop="stageMoney" min-width="100" label="本次抄码">
                <template slot-scope="scope">
                  <el-input 
                    v-model="scope.row.stageMoney"
                    placeholder="请输入本次抄码">
              ...
              <el-table-column prop="stageMoney" min-width="100" label="检查结果">
                <template slot-scope="scope">
                  <el-input 
                    v-model="scope.row.stageMoney"
                    placeholder="请输入检查结果">
