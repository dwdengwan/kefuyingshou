  ...
  <div class="Meter-Reading-Record">
    <div class="bread-contain">
      ...
      <div class="bread-contain-right" v-else-if='divChange==2'>
        ...
        <el-button size="mini" type="primary">清除已抄</el-button>
        <el-button icon="el-icon-caret-left" size="mini" @click="callBack()">返回</el-button>
      </div>
      <!-- <h2 class="tab-title">
        <i></i>
    ...
    <div class="Meter-Reading-Record-right-content" v-if='divChange==1'>
      <div class="kr-left">
      ...
      <div class="kr-right">
        <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline" style="padding: 0px 20px;">
          ...
          <el-form-item label="抄表状态：" class="longinput">
            ...
            <!-- <el-input v-model="formData.inputContent1" clearable placeholder="抄表状态"></el-input> -->
          </el-form-item>
          <el-form-item>
        ...
        <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="tableData" @cell-click="cellClick" class="wuserInfo-table">
          ...
          <!-- <el-table-column prop="userNum" min-width="100" label="抄表ID"></el-table-column> -->
          <el-table-column prop="userCode" min-width="100" label="用户编号"></el-table-column>
          <!-- <el-table-column prop="userNum" min-width="100" label="排序号"></el-table-column> -->
          <el-table-column prop="userName" min-width="100" label="用户名称"></el-table-column>
          <el-table-column prop="userAddress" min-width="200" label="用户地址" show-overflow-tooltip></el-table-column>
          <el-table-column prop="userStart" min-width="100" label="上期抄码"></el-table-column>
          <el-table-column prop="userEnd" min-width="100" label="本期抄码"></el-table-column>
          <el-table-column prop="copyList" min-width="100" label="本期水量"></el-table-column>
          <el-table-column prop="addWrite" min-width="100" label="增减水量"></el-table-column>
          <el-table-column prop="meterAddress" min-width="80" label="分摊水量"></el-table-column>

          <el-table-column prop="userWrite" min-width="100" label="实际用水量"></el-table-column>
          <el-table-column prop="copyData" min-width="100" label="抄表日期"></el-table-column>
          <el-table-column prop="copyState" min-width="100" label="抄表状态"></el-table-column>
          <el-table-column prop="state" min-width="100" label="用户状态"></el-table-column>
          <el-table-column prop="userPeople" min-width="100" label="抄表员"></el-table-column>
          <el-table-column label="操作" fixed="right" width="120px">
            <template slot-scope="scope">
              <el-button type="text" @click="luru()" style="font-size:12px;">编辑</el-button>
              <el-button type="text"  style="font-size:12px;">查看附件</el-button>
            </template>
          </el-table-column>
...
export default {
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '抄表', },
          { title: '抄表记录', method: () => { window.histroy.back() } }
        ],
      },
      treeDatas: {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      ...
      this.$changeTable(this, '.Meter-Reading-Record .Meter-Reading-Record-right', ['.Meter-Reading-Record .table-top'])
    })
    let myDate = new Date();
    this.formData.beginYearM = myDate.getFullYear() + '-' + (Number(myDate.getMonth()) + 1) + '-' + myDate.getDate();
  },
  methods: {
    ...
    cellClick(row, column, cell, event) { //点击文件名
      ...
      if (column.label === '水表编号') {
        ...
        if(this.realTimeData.name!=null){
          this.nameRealDate = this.$route.query.name+"  "+this.realTimeData.code+"（"+this.realTimeData.name+"）"
        }else{
    ...
    luru() {//录入
      this.crumbsData = {  //面包屑
        titleList: [
          { title: '抄表中心', path: '/MeterReadingCenter' },
          { title: '抄表记录', path: '/MeterReadingRecord' },
