    ...
    <el-form :model="dialogForm" ref="form" :rules="rules" label-width="100px">
      ...
      <div class="my-input1">
        <el-form-item label="抄 表 员：" prop="meterReader">
          <el-select v-model="dialogForm.meterReader" clearable size="mini" style="width: 100%">
      ...
      <!-- <div class="my-input1">
          <el-form-item label="催 缴 员：" prop="paymentCollector">
            <el-select v-model="dialogForm.paymentCollector" clearable size="mini" style="width: 100%">
              <el-option v-for="item in meterReaderList" :key="item.value" :label="item.label" :value="item.value"></el-option>
            </el-select>
          </el-form-item>
        </div> -->
      <div class="my-input1">
        <el-form-item label="抄表周期：" prop="meterReadingPeriod">
          <el-select v-model="dialogForm.meterReadingPeriod" clearable size="mini" style="width: 100%">
      ...
      <!-- <div class="my-input1">
          <el-form-item label="册本类别：" prop="bookType">
            <el-select v-model="dialogForm.bookType" clearable size="mini" style="width: 100%">
              <el-option label="私户" value="1"></el-option>
              <el-option label="公户" value="2"></el-option>
            </el-select>
          </el-form-item>
        </div> -->
      <div class="my-input1">
        <el-form-item label="营业网点：" prop="selectionArea">
          <el-select v-model="dialogForm.selectionArea" clearable size="mini" style="width: 100%">
            <el-option label="城区" value="1"></el-option>
          </el-select>
        </el-form-item>
      </div>
      <!-- <div class="my-input1">
          <el-form-item label="组 代 号：" prop="groupDesignator">
            <el-input v-model="dialogForm.groupDesignator" size="mini" clearable></el-input>
          </el-form-item>
        </div> -->
      <div class="my-input1">
      ...
      <!-- <div class="my-input1">
          <el-form-item label="排 序 号：" prop="sortNum">
            <el-input v-model="dialogForm.sortNum" size="mini" clearable></el-input>
          </el-form-item>
        </div> -->
      <div class="my-input1">
        <el-form-item label="状态：" prop="state">
          <el-select v-model="dialogForm.state" clearable size="mini" style="width: 100%">
      ...
      <div class="my-input1 gocenter2">
        <el-form-item label="描述：" prop="describe">
          <el-input type="textarea" v-model="dialogForm.describe" style="width:100%"></el-input>
        </el-form-item>
      </div>
    </el-form>
  </div>
  <div class="MeterReadingCircuit" v-else>
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="tableData" @cell-click="cellClick" class="wuserInfo-table">
        ...
        <el-table-column prop="lvalue" min-width="80" label="营业网点">
        </el-table-column>
        ...
        <el-table-column label="操作" fixed="right" width="85">
          <template slot-scope="scope">
            <el-button type="text" @click.native="edit" style="font-size:12px;">编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
...
export default {
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '表册', path: '/BookInfo' },
          { title: '册本信息', method: () => { window.histroy.back() } }
        ],
  ...
  mounted() {
    ...
    this.$changeTable(this, '.MeterReadingCircuit .kl-table', ['.MeterReadingCircuit .toolbar', '.MeterReadingCircuit .block', '.MeterReadingCircuit bread-contain'])
  },
  methods: {
    init() {
