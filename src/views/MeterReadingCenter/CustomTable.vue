  ...
  <div class="CustomTable">
        ...
        <el-form-item class="form-left">
          ...
          <el-form-item label="客户类型：">
            <el-select v-model="formData.priceClassification" size="mini">
              ...
              <el-option label="二级客户" value="1"></el-option>
              <el-option label="一级客户" value="2"></el-option> -->
    ...
    <div class="kl-table">
      <el-table stripe border :data="histroyData.list" @cell-click="cellClick" class="wuserInfo-table">
        ...
        <el-table-column prop="meterAddress" min-width="80" label="客户地址"></el-table-column>
        <el-table-column prop="meterAddress" min-width="80" label="客户类型"></el-table-column>
...
export default {
  ...
  mounted() {
    ...
    this.$changeTable(this, '.CustomTable .kl-table', ['.CustomTable .toolbar', '.CustomTable .block', '.CustomTable bread-contain'])
  },
  methods: {
    init() {
