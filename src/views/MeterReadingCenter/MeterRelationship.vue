  ...
  <div class="MeterRelationship" v-if="dialogTableVisible">
    ...
    <div class="toolbar">
      <el-form :inline="true" size="mini" :model="formData5" class="demo-form-inline">
        ...
        <!-- <el-form-item label="分摊方式：" style="float: right" v-if='activeName !== "third"'>
          <el-select v-model="apportionmentMode" size="mini">
            <el-option label="总表分摊" value="1"></el-option>
            <el-option label="分表分摊" value="2"></el-option>
          </el-select>
        </el-form-item> -->
    ...
    <el-dialog title="添加" :visible.sync="addVisible">
      <div class="toolbar">
        <el-form :inline="true" size="mini" :model="formData5" class="demo-form-inline">
          ...
          <el-form-item label="水表编号：">
            <el-input v-model="formData5.GeneralTableNum1" placeholder="请输入水表编号"></el-input>
          </el-form-item>
          <el-form-item label="册本号：">
            <el-input v-model="formData5.GeneralTableNum2" placeholder="请输入册本号"></el-input>
          </el-form-item>
          <el-form-item label="水表口径：">
            <el-input v-model="formData5.GeneralTableNum3" placeholder="请输入水表口径"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <div class="kl-table">
        <el-table stripe border :data="tableData" class="change-tables-table">
          ...
          <el-table-column prop="bookCode" min-width="100" label="册本">
          </el-table-column>
          ...
          <el-table-column prop="address" min-width="100" label="装表地址">
          </el-table-column>

          <el-table-column prop="goldLevel" min-width="100" label="水表编号">
          </el-table-column>
        </el-table>
        <div class="block">
          <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="1" :page-sizes="[20, 100, 500, 1000]" :page-size="20" layout="total, sizes, prev, pager, next, jumper" :total="histroyData.total">
        ...
        <div class='first-center'>
          ...
          <div class="kl-table">
            <el-table stripe border :data="tableData" class="change-tables-table">
              ...
              <!-- <el-table-column prop="engineeringType" min-width="180" label="册本号">
              </el-table-column>

              <el-table-column prop="daytime" min-width="100" label="册本">
              </el-table-column> -->
              ...
              <!-- <el-table-column prop="gold" min-width="80" label="分摊方式">
              </el-table-column> -->
            </el-table>
            <!-- 分页 -->
            <!-- <div class="block">
        ...
        <div class='first-left'>
          <div class="toolbar">
            <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
              ...
              <!-- <el-form-item label="分摊方式：" style="margin-left: 3%;">
                <el-select v-model="apportionmentMode" size="mini">
                  <el-option label="总表分摊" value="1"></el-option>
                </el-select>
              </el-form-item> -->
              ...
              <el-form-item label="">
                <el-input v-model="formData.beginNumber" placeholder="用户编号" style="width: 45%;"></el-input>
                <!-- 至 -->
                <!-- <el-input v-model="formData.endNumber" placeholder="用户编号" style="width: 45%;"></el-input> -->
              </el-form-item>
              ...
              <el-form-item style="float: right;">
                ...
                <!-- <el-button size="mini" type="primary">保存</el-button> -->
                <!-- <el-button size="mini" type="primary">删除全部</el-button> -->
                <!-- <el-button size="mini" type="primary" icon="el-icon-upload2">导出</el-button> -->
              </el-form-item>
            </el-form>
          </div>
          <div class="kl-table">
            <el-table stripe border :data="tableData" class="change-tables-table">
              ...
              <!-- <el-table-column label="操作" fixed="right" width="85">
                <template slot-scope="scope">
                  <el-button type="text" @click.native="handleContent = true" style="font-size:12px;">删除</el-button>
                </template>
              </el-table-column> -->
            </el-table>
            <!-- 分页 -->
        ...
        <div class='first-left'>
          <div class="toolbar">
            <el-form :inline="true" size="mini" :model="formData2" class="demo-form-inline">
              ...
              <el-form-item label="" style="margin-left:.5rem;">
                ...
                <!-- 至
                <el-input v-model="formData2.endNumber" placeholder="用户编号" style="width: 45%;"></el-input> -->
              </el-form-item>
              <el-form-item>
                <el-button class="searchBtn" @click="demand" icon="el-icon-search"></el-button>
              </el-form-item>
          ...
          <div class="kl-table">
            <el-table stripe border :data="tableData" class="change-tables-table">
              ...
              <!-- <el-table-column label="操作" fixed="right" width="85">
                <template slot-scope="scope">
                  <el-button type="text" @click.native="handleContent = true">删除</el-button>
                </template>
              </el-table-column> -->
            </el-table>
            <!-- 分页 -->
...
export default {
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '水表关系', path:'/MeterRelationship' },
  ...
  mounted() {
    ...
    this.$changeTable(this, '.MeterRelationship .kl-table', ['.MeterRelationship .toolbar', '.MeterRelationship .block', '.MeterRelationship bread-contain'])
  },
  methods: {
    init() {
    ...
    handleClick(){
      if(this.activeName == 'third'){
        this.$set(this.crumbsData.titleList[2],'title','监控表设置')
      }else if(this.activeName == 'fourth'){
        this.$set(this.crumbsData.titleList[2],'title','消防表设置')
      }else if(this.activeName == 'first'){
        this.$set(this.crumbsData.titleList[2],'title','总分表设置')
      }
    },
    demand() {  //查询
