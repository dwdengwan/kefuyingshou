  ...
  <div class="BatchOpening">
    <div class="bread-contain">
      ...
      <div class="bread-contain-right">
        <el-button size="mini" type="primary">批量开账</el-button>
        <el-button size="mini" type="primary">取消开账</el-button>
      </div>
    </div>
    ...
    <div class="toolbar">
      <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
        ...
        <!-- <el-form-item label="抄表日：">
          <el-select v-model="formData.beginNumber1" clearable size="mini" style="width:100%">
            <el-option v-for="item in options6" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item> -->

        <el-form-item label="账期：" class="longinput">
          <el-date-picker v-model="formData.inputContent" size="mini" type="month" unlink-panels format="yyyyMM" value-format="yyyyMM" placeholder="选择月" style="width:100%;">
            </el-date-picker>
          <!-- <el-input v-model="formData.inputContent" placeholder="账期"></el-input> -->
        </el-form-item>

        <el-form-item label="册本号：" class="longinput">
          <el-input v-model="formData.inputContent1" placeholder="册本号"></el-input>
        </el-form-item>
        
        <el-form-item label="开账状态：">
          <el-select v-model="formData.beginNumber" clearable size="mini" style="width:100%">
            <el-option v-for="item in options6" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="tableData" @cell-click="cellClick" class="wuserInfo-table">
        ...
        <el-table-column prop="lastPeople" min-width="80" label="开账人">
        </el-table-column>

        <el-table-column prop="lastTime" min-width="180" label="开账时间">
        </el-table-column>
...
export default {
    ...
    return {
      ...
      crumbsData: {  //面包屑
        titleList: [
          ...
          { title: '批量开账', method: () => { window.histroy.back() } }
        ],
  ...
  mounted() {
    ...
    this.$changeTable(this, '.BatchOpening .kl-table', ['.BatchOpening .toolbar', '.BatchOpening .block', '.BatchOpening bread-contain'])
  },
  methods: {
    init() {
