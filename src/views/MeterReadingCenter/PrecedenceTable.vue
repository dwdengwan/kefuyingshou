  ...
  <div class="PrecedenceTable">
    ...
    <div class="toolbar">
      <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline">
        <el-form-item class="form-left">
          ...
          <el-form-item label="账期：" width="200">
            ...
            <!-- -
            <el-date-picker v-model="formData.endYearM" size="mini" type="month" unlink-panels format="yyyyMM" value-format="yyyyMM" placeholder="选择月" style="width:48% !important;">
            </el-date-picker> -->
          </el-form-item>
          ...
          <el-form-item label="抄表员：">
            <el-select v-model="formData.meterReader" size="mini">
              ...
              <el-option label="胡国飞" value="1"></el-option>
          ...
          <el-form-item label="用水类型：">
            <el-select v-model="formData.priceClassification" size="mini">
              ...
              <!-- <el-option label="0015_特低用水" value="1"></el-option>
              <el-option label="0020_区域用水" value="2"></el-option>
              <el-option label="0030_基本水费" value="3"></el-option>
              <el-option label="0037_桥口水费" value="4"></el-option>
              <el-option label="0038_工业用水" value="5"></el-option>
              <el-option label="0039_特种用水" value="6"></el-option>
              <el-option label="0040_生活用水" value="7"></el-option>
              <el-option label="0041_免费用水" value="8"></el-option>
              <el-option label="0042_集中区域" value="9"></el-option>
              <el-option label="0042_无阶梯" value="10"></el-option> -->
            </el-select>
          </el-form-item>
          ...
          <!-- <el-form-item label="用水类型：">
            <el-input v-model="formData.waterType" placeholder="请输入用水类型"></el-input>
          </el-form-item> -->
    ...
    <div class="kl-table">
      <el-table v-if="tableShow" :max-height="maxHeight" stripe border :data="histroyData.list" @cell-click="cellClick" class="wuserInfo-table">
        ...
        <el-table-column prop="userNum" min-width="100" label="册本号"></el-table-column>
        <!-- <el-table-column prop="userName" min-width="80" label="排序号"></el-table-column> -->
        ...
        <el-table-column prop="meterAddress" min-width="80" label="用户地址"></el-table-column>
...
export default {
  ...
  mounted() {
    ...
    this.$changeTable(this, '.PrecedenceTable .kl-table', ['.PrecedenceTable .toolbar', '.PrecedenceTable .block', '.PrecedenceTable bread-contain'])
  },
  methods: {
    init() {
