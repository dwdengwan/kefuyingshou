  ...
  <div class="ProjectProvision">
    ...
    <el-form :inline="true" size="mini" :model="formData" class="demo-form-inline" style="padding: 10px 20px 0;">
      ...
      <el-form-item label="模糊查询：">
          ...
          <el-tooltip class="item" effect="dark" content="工程编号、工程名称、业主名称、用水地址" placement="top">
      ...
      <!-- <el-form-item label="查询条件：">
        <el-select class="searchType" v-model="formData.searchType" placeholder="请选择搜索类型">
          ...
          <el-option label="业主名称" value='3'></el-option>
          <el-option label="用水地址" value='4'></el-option>
        </el-select>
    ...
    <div class="kl-table">
      <el-table stripe border :data="tableData" class="change-tables-table">
        ...
        <el-table-column prop="address" min-width="80" label="用水地址" show-overflow-tooltip>
        </el-table-column>

        <el-table-column prop="engineeringTime" min-width="120" label="验收日期">
        </el-table-column>
        ...
        <el-table-column prop="telphone1" min-width="80" label="人工费用" show-overflow-tooltip>
        </el-table-column>

        <el-table-column prop="userLevel1" min-width="80" label="税前合计" show-overflow-tooltip>
        </el-table-column>

        <el-table-column prop="useLevel1" min-width="80" label="应纳税额" show-overflow-tooltip>
        </el-table-column>

        <el-table-column prop="waterTime1" min-width="80" label="税后金额" show-overflow-tooltip>
        </el-table-column>

        <el-table-column prop="waterNum1" min-width="80" label="提成金额" show-overflow-tooltip>
        </el-table-column>

        <el-table-column prop="waterNum2" min-width="80" label="施工班组" show-overflow-tooltip>
        </el-table-column>

        <el-table-column label="操作" fixed="right" width="180">
          <template slot-scope="scope">
            <el-button type="text" size="mini">材料费用</el-button>
            <span class="lineBox">
              <div class="line"></div>
            </span>
            <el-button type="text" size="mini">人工费用</el-button>
            <span class="lineBox">
              <div class="line"></div>
            </span>
            <el-button type="text" size="mini">班组</el-button>
          </template>
        </el-table-column>
