  ...
  <div class="handleInfo">
    <div class="bread-contain">
      ...
      <div class="bread-contain-right" v-if='operationShow == 3 && !isExecution'>
        ...
        <el-button size="mini" type="primary" @click="saveEditContent(3)">提交</el-button>
        <el-button size="mini" type="primary">工程暂停</el-button>
        <el-button size="mini" type="primary" icon="el-icon-plus">处理意见</el-button>
        <el-button  icon="el-icon-caret-left" size="mini" @click="operationReturn" style="margin-right: 1.5%">返回</el-button>
      </div>
      ...
      <div class="bread-contain-right" v-if='operationShow == 6 && !isExecution && !editContent'>
        ...
        <el-button size="mini" type="primary" @click="saveEditContent(6)">提交</el-button>
        <el-button size="mini" type="primary" icon="el-icon-plus">处理意见</el-button>
        <el-button  icon="el-icon-caret-left" size="mini" @click="operationReturn" style="margin-right: 1.5%">返回</el-button>
      </div>
      <div class="bread-contain-right" v-if='operationShow == 6 && isExecution && !editContent'>
      ...
      <div class="bread-contain-right" v-if='operationShow == 10'>
        <!-- <el-button size="mini" type="primary">立户</el-button> -->
        <!-- <el-button size="mini" type="primary">上传附件</el-button>
        <el-button size="mini" type="primary">打印收据</el-button>
        <el-button size="mini" type="primary">打印发票</el-button>
      ...
      <div class='operation_one-bottom'>
            <el-form :model="ruleForm" ref="form" :show-message="false" :rules="rules" label-width="130px">
                ...
                <!-- <el-col :span="6">
                  <div class="my-input">
                    <el-form-item label="街区：" prop="block">
                      <el-input v-model="ruleForm.block" size="mini" clearable></el-input>
                    </el-form-item>
                  </div>
                </el-col> -->
                <el-col :span="6">
              ...
              <el-row>
                ...
                <!-- <el-col :span="6">
                  <div class="my-input">
                    <el-form-item label="用水人口：" prop="waterPopulation">
                      <el-input v-model="ruleForm.waterPopulation" size="mini" clearable></el-input>
                    </el-form-item>
                  </div>
                </el-col> -->
            ...
            <el-form 
                  ...
                  <legend>
                    客户信息
                    <el-button size="mini" type="primary" style="float: right;margin-top: -5px;" @click="chooseCtm">选择客户</el-button>
                  </legend>
                  ...
                  <el-row>
                    ...
                    <!-- <el-col :span="6">
                      <el-form-item label="联系电话：">
                        <el-input v-model="countManagementEditForm.backfillInput.peopleTel" placeholder="13662592308" class="read-only"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="6">
                      <el-form-item label="联系人：">
                        <el-input v-model="countManagementEditForm.backfillInput.people" placeholder="谢顺新" class="read-only"></el-input>
                      </el-form-item>
                    </el-col> -->
                  </el-row>
                  ...
                  <!-- <el-row>
                    <el-col :span='6'>
                      <el-form-item label="客户地址：">
                        <el-input v-model="countManagementEditForm.backfillInput.peopleAddress" placeholder="宝积山路、体育巷" class="read-only"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span='6'>
                      <el-form-item label="客户名称：">
                        <el-input v-model="countManagementEditForm.backfillInput.peopleName" placeholder="谢顺新" class="read-only"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span='6'></el-col>
                    <el-col :span='6'></el-col>
                  ...
                  <el-row>
                    <el-col :span='6'>
                      ...
                      <el-form-item label="账户编号：">
                        <el-input v-model="countManagementEditForm.countMsg.PriceStrategy" placeholder="新立户" disabled class="read-only"></el-input>
                      </el-form-item>
                    </el-col>
                  ...
                  <el-row>
                    ...
                    <!-- <el-col :span='6'>
                      <el-form-item label="状态：">
                        <el-select  clearable v-model="countManagementEditForm.countMsgOrder.Remarks" placeholder="">
                          <el-option  v-for="(item,index) in countManagementEditForm.descoptions" :key="index" :label="item.name" :value="item.value"></el-option>
                        </el-select>
                      </el-form-item>
                    </el-col> -->
                    <!-- <el-col :span='6'>
                      <el-form-item label="签约日期:">
                        <el-date-picker
                          v-model="countManagementEditForm.countMsgOrder.value3"
                          type="date"
                  ...
                  <!-- <el-row>
                    ...
                    <el-col :span='24'>
                      <el-form-item class="kr-col">
                        <el-checkbox-group v-model="countManagementEditForm.descoptions">
    ...
    <div v-if="operationShow == 2" class="operation_box">
      <!-- <span class="btnBox">
        ...
        <el-button size="mini" type="primary">工程暂停</el-button>
        <el-button size="mini" type="primary" icon="el-icon-plus">处理意见</el-button>
        <el-button  icon="el-icon-caret-left" size="mini" @click="operationReturn" style="margin-right: .8%">返回</el-button>
      </span> -->
      <el-form :model="ruleForm1" ref="form" :rules="rules" label-width="100px">
        ...
        <div class="my-input1 gocenter2" style="margin-bottom: 1%;">
          <el-form-item label="设计说明：" prop="explain">
            <el-input type="textarea" v-model="ruleForm1.explain" style="width:100%"></el-input>
          </el-form-item>
        </div> -->
      </el-form>
      <!-- <div class="kl-table">
    ...
    <div class="operation_box" v-if="operationShow == 5">
      ...
      <el-form :model="ruleForm4" ref="form" :rules="rules" label-width="100px">
        ...
        <!-- <div class="my-input1">
          <el-form-item label="预算收款方式：" prop="budgetCollectionMethod">
            <el-select v-model="ruleForm3.budgetCollectionMethod" clearable size="mini" style="width:100%">
    ...
    <div class="operation_box" v-if="operationShow == 6">
      <!-- <span class="btnBox">
        <el-button size="mini" type="primary">上传附件</el-button>
        <el-button size="mini" type="primary">施工材料</el-button>
        <el-button size="mini" type="primary">多水表录入</el-button>
        <el-button size="mini" type="primary">提交</el-button>
        <el-button size="mini" type="primary" icon="el-icon-plus">处理意见</el-button>
        <el-button  icon="el-icon-caret-left" size="mini" @click="operationReturn" style="margin-right: .8%">返回</el-button>
      </span> -->
      ...
      <el-form :model="ruleForm9" ref="form" :rules="rules" label-width="100px">
        ...
        <div class="my-input1">
          <el-form-item label="银行账户：" prop="bankAccount" class="id-card">
            <!-- <el-input v-model="ruleForm7.bankAccount" size="mini" clearable></el-input> -->
    ...
    <div v-if='editContent && !uploadPic && !isExecution'>
      <waterMeter :isEdit="isEdit" :isShow="isShow"></waterMeter>
    </div>
...
export default {
  components: {
    steps,uploadFile,execution,waterMeter
  },
  data() {
    return {
      activeName: 'first',
  ...
  mounted() {
    ...
    if(window.location.href.split('#')[1] == '/ProcessingCompleted'){
      this.$set(this.crumbsData.titleList,"2",{title:'处理完成',method:()=>{window.histroy.back()}})
    }else if(window.location.href.split('#')[1] == '/AllProjects'){
  ...
  methods: {
    ...
    submitForm(formName){//步骤条-工程登记-保存/提交
    },
