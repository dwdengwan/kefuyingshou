...
<handleInfo v-if="handleContent"></handleInfo>
  <div class="AllProjects" v-else>
      ...
      <el-table stripe border :data="tableData" class="change-tables-table">
        ...
        <el-table-column label="操作" fixed="right" width="85">
          <template slot-scope="scope">
            <el-button type="text" @click.native="handleContent = true" style="font-size:12px;">查询</el-button>
          </template>
        </el-table-column>
    ...
    <!-- <el-dialog id="dialogBox" :close-on-click-modal="false" title="查询详情" :visible.sync="handleContent">
      <handleInfo v-if="handleContent"></handleInfo>
    </el-dialog> -->
  </div>
</template>
    ...
    return {
      ...
      crumbsData: { //面包屑
        titleList: [
          ...
          { title: '全部工程', method: () => { window.histroy.back() } }
        ],
      },
      inforList: [
        { value: 1, label: '全部' },
